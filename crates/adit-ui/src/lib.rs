...
pub struct AditApp {
    ...
    /// Editor mirror of `ConnectionProfile::keep_connection_after_exit`.
    profile_keep_connection: bool,
...
pub enum Message {
    ...
    SftpConfirmDelete,
    SftpCancelDelete,
    ProfileKeepConnectionToggled(bool),
